...
## Puesta en Marcha
Para ejecutar los programas, asegúrate de tener [Python](https://www.python.org/downloads/) instalado en tu sistema. Luego, clona este repositorio y navega hasta el directorio del programa que deseas ejecutar. Usa el siguiente comando en tu terminal:
